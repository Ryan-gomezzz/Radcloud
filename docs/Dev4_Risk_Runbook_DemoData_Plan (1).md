...
**Stack:** Python, **Anthropic Claude via AWS Bedrock** (not the direct Anthropic API)  
...
The runbook follows a fixed phase structure. Claude (via Bedrock) fills in the specific steps based on the migration context.
